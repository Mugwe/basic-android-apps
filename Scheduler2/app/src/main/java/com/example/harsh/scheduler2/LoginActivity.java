...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent myIntent = new Intent(getApplicationContext(), SignUpActivity.class);
                ...
                final class Des extends AsyncTask<Void, Void, Void> {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            String url = "https://files.000webhost.com/public_html/login.php";
                            URL obj = new URL(url);
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        try {
                            ...
                            if (code == 1) {
                                ...
                                final android.app.AlertDialog.Builder alert = new android.app.AlertDialog.Builder(getApplicationContext());
                                ...
                                alert.show();
                                Toast.makeText(getApplicationContext(), "Hurray!!", Toast.LENGTH_LONG).show();
                                Intent mynew = new Intent(getApplicationContext(),MainActivity.class);
                                startActivity(mynew);
                            }  else {
                                final android.app.AlertDialog.Builder alert = new android.app.AlertDialog.Builder(getApplicationContext());
                                LinearLayout lila1 = new LinearLayout(getApplicationContext());
